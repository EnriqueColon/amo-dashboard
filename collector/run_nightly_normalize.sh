...
#
# Cron entry (crontab -e), 04:30 every night:
#   30 4 * * * /opt/amo-dashboard/collector/run_nightly_normalize.sh >> /opt/amo-dashboard/collector/batch/normalize_nightly.log 2>&1
#
